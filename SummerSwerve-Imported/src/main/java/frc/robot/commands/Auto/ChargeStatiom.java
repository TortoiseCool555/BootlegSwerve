...
public class ChargeStatiom extends SequentialCommandGroup {
  /** Creates a new ChargeStatiom. */
  public ChargeStatiom(NewSwerveDrivetrain drivetrain, Elevator elevator) {
